...
void MainWindow::calcularMedia() { calcularMetrica("Media", Estadistica::media); }
void MainWindow::calcularMediana() { calcularMetrica("Mediana", Estadistica::mediana); }
void MainWindow::calcularVarianza() { calcularMetrica("Varianza", [](auto d){ return Estadistica::varianza(d); }); }
void MainWindow::calcularDesviacion() { calcularMetrica("Desviación", [](auto d){ return Estadistica::desviacionEstandar(d); }); }

void MainWindow::calcularModa() {
    try {
...
void MainWindow::analizarBivariado() {
...
void MainWindow::actualizarUIAfterCargar() {
...
void MainWindow::calcularMetrica(const QString& nombre, Func funcion) {
    try {
        int idx = cmbVariableUni->currentIndex();
        if (idx < 0 || idx >= datos.size()) return;
...
void MainWindow::mostrarHistograma(const QVector<double>& datosVar) {
...
void MainWindow::mostrarScatterPlot(const QVector<double>& x, const QVector<double>& y) {
